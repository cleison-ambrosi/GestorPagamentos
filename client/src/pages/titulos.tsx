    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 ml-64">
        <header className="bg-white shadow-sm border-b border-slate-200 px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600">Gerenciamento de títulos a pagar</p>
            </div>
        ...
        <div className="p-8">
          <Card>
            <CardHeader>
              <h3 className="text-lg font-semibold">Lista de Títulos</h3>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                <p>Carregando...</p>
                ...
                <div className="text-center py-8">
                  <p className="text-slate-600">Nenhum título encontrado</p>
                  <p className="text-sm text-slate-500 mt-1">Clique em "Novo Título" para começar</p>
                </div>
              )}
            </CardContent>
          </Card>
