...
export default function Titulos() {
  ...
  const saveEmpresaTitulosMutation = useMutation({
    mutationFn: (empresaNome: string) => {
      ...
      return apiRequest("/api/configuracao/empresa-titulos", "POST", { idEmpresa: empresa.id });
    },
    onSuccess: () => {
  ...
  const handleEmpresaChange = (empresaNome: string) => {
    ...
    saveEmpresaTitulosMutation.mutate(empresaNome);
  };
