      ...
      <main className="flex-1 ml-64">
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                <h3 className="text-lg font-semibold">Relatório de Vencimentos</h3>
                <p className="text-sm text-slate-600">Títulos por período de vencimento</p>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <h3 className="text-lg font-semibold">Relatório por Empresa</h3>
                <p className="text-sm text-slate-600">Análise financeira por empresa</p>
              </CardHeader>
              <CardContent>
                <Button className="w-full">
                  <Download className="h-4 w-4 mr-2" />
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-slate-600">Pagamentos por fornecedor</p>
              </CardHeader>
              <CardContent>
                <Button className="w-full">
                  <Download className="h-4 w-4 mr-2" />
